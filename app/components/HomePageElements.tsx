...
export default function HomePageElements({ selectedType, onTypeSelectAction }: HomePageElementsProps) {
    ...
    const panelClasses = "relative w-full h-full aspect-[5/6]] overflow-hidden text-center cursor-pointer transition-all duration-200 ease-in-out hover:scale-[1.02] hover:brightness-110 rounded-lg";
    ...
    return (
        <div className="h-screen overflow-hidden p-2">
            <div className="h-full grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 grid-rows-3 gap-3">
                ...
                >
                    <img src="/images/coral-panel-1.png" className="w-full h-full object-cover object-contain rounded-lg" />
                ...
                >
                    <img src="/images/basic-panel.png" className="w-full h-full object-cover object-contain rounded-lg" />
                ...
                >
                    <img src="/images/coral-panel-2.png" className="w-full h-full object-cover object-contain rounded-lg" />
                ...
                >
                    <img src="/images/coral-panel-3.png" className="w-full h-full object-cover object-contain rounded-lg" />
